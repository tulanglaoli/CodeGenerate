            ...
            while (p != ParseState.End)
            {
                ...
                switch (p)
                {
                    ...
                    case ParseState.BodyName:
                        ...
                        p = ParseState.ElementValue;
                        break;
                    case ParseState.ElementValue:
                        string[] l = ParseWord("\t\n\r )+>*").Replace("(", "").Split(new char[1] { '|' }, System.StringSplitOptions.RemoveEmptyEntries);
                        EatSpecialKey(")");
                    ...
                    case ParseState.BodyName2:
                        ...
                        {
                            error = "Element's Name:" + DB.Name + "!= ATTLIST's Name:" + bn2;
                            p = ParseState.error; ;
                        }
                        break;
